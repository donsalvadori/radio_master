...
function EsnextFilter(inputTree, options) {
  console.warn(chalk.red('[deprecated]') + ' broccoli-esnext is deprecated. Use broccoli-babel-transpiler instead. ' + chalk.gray('https://github.com/babel/broccoli-babel-transpiler'));
